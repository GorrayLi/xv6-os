...
int main(int argc, char* argv[])
{
   ...
   8:	1800                	addi	s0,sp,48
    ...
    if (argc > 1){
   a:	4785                	li	a5,1
   c:	02a7d063          	bge	a5,a0,2c <main+0x2c>
        fprintf(2,"usage: pingpong\n");
  10:	00001597          	auipc	a1,0x1
  14:	89858593          	addi	a1,a1,-1896 # 8a8 <malloc+0xe4>
  18:	4509                	li	a0,2
  1a:	00000097          	auipc	ra,0x0
  1e:	6be080e7          	jalr	1726(ra) # 6d8 <fprintf>
        exit(1);
  22:	4505                	li	a0,1
  24:	00000097          	auipc	ra,0x0
  28:	36a080e7          	jalr	874(ra) # 38e <exit>
    }

    pipe(p);
  2c:	fd040513          	addi	a0,s0,-48
  30:	00000097          	auipc	ra,0x0
  34:	36e080e7          	jalr	878(ra) # 39e <pipe>
    if (fork() == 0){
  38:	00000097          	auipc	ra,0x0
  3c:	34e080e7          	jalr	846(ra) # 386 <fork>
  40:	e525                	bnez	a0,a8 <main+0xa8>
        pid = getpid();
  42:	00000097          	auipc	ra,0x0
  46:	3cc080e7          	jalr	972(ra) # 40e <getpid>
  4a:	84aa                	mv	s1,a0
        read(p[0], &content, 1);
  4c:	4605                	li	a2,1
  ...
  5a:	350080e7          	jalr	848(ra) # 3a6 <read>
        close(p[0]);
  5e:	fd042503          	lw	a0,-48(s0)
  62:	00000097          	auipc	ra,0x0
  66:	354080e7          	jalr	852(ra) # 3b6 <close>
        printf("%d: received ping\n", pid);
  6a:	85a6                	mv	a1,s1
  6c:	00001517          	auipc	a0,0x1
  70:	85450513          	addi	a0,a0,-1964 # 8c0 <malloc+0xfc>
  74:	00000097          	auipc	ra,0x0
  78:	692080e7          	jalr	1682(ra) # 706 <printf>
        write(p[1], "0", 1);
  7c:	4605                	li	a2,1
  7e:	00001597          	auipc	a1,0x1
  82:	85a58593          	addi	a1,a1,-1958 # 8d8 <malloc+0x114>
  86:	fd442503          	lw	a0,-44(s0)
  8a:	00000097          	auipc	ra,0x0
  8e:	324080e7          	jalr	804(ra) # 3ae <write>
        close(p[1]);
  92:	fd442503          	lw	a0,-44(s0)
  96:	00000097          	auipc	ra,0x0
  9a:	320080e7          	jalr	800(ra) # 3b6 <close>
        exit(0);
  9e:	4501                	li	a0,0
  ...
  ac:	366080e7          	jalr	870(ra) # 40e <getpid>
  b0:	84aa                	mv	s1,a0

        write(p[1], "0", 1);
  b2:	4605                	li	a2,1
  b4:	00001597          	auipc	a1,0x1
  b8:	82458593          	addi	a1,a1,-2012 # 8d8 <malloc+0x114>
  bc:	fd442503          	lw	a0,-44(s0)
  c0:	00000097          	auipc	ra,0x0
  c4:	2ee080e7          	jalr	750(ra) # 3ae <write>
        close(p[1]);
  c8:	fd442503          	lw	a0,-44(s0)
  cc:	00000097          	auipc	ra,0x0
  d0:	2ea080e7          	jalr	746(ra) # 3b6 <close>
        wait(0);
  d4:	4501                	li	a0,0
  d6:	00000097          	auipc	ra,0x0
  da:	2c0080e7          	jalr	704(ra) # 396 <wait>

        read(p[0], &content, 1);
  de:	4605                	li	a2,1
  e0:	fdf40593          	addi	a1,s0,-33
...
malloc(uint nbytes)
{
 ...
 84e:	0ca73723          	sd	a0,206(a4) # 918 <freep>
      return (void*)(p + 1);
